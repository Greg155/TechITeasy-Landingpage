...
window.onload = function () {
  ...
  document.querySelector('.arrow').addEventListener('click', function (e) {
    e.stopPropagation();
    document.getElementsByClassName('subscribe')[0].scrollIntoView({
      behavior: "smooth"
    });
  });
  var sectionHead = document.getElementsByClassName('hero');
  var bodyHeigt = document.body.clientHeight;
  console.log(sectionHead[0].clientHeight);
  var cursor = document.getElementsByClassName('cursor')[0];

  var divBottom = function divBottom(elem) {
  ...
  */
  ...
  window.onmousemove = function (e) {
    //console.log(e)
    if (e.target.classList.value === "subhead") {// console.log("sub")
  ...
  var h2 = document.querySelector('.subscribe h2');
